...
import app.pulse.compose.persist.findActivityNullable
import app.pulse.core.ui.utils.isAtLeastAndroid12
import app.pulse.core.ui.utils.isAtLeastAndroid7
    ...
    activity.setPipParams(
        ...
        if (actions != null) setActions(
            actions.all.values.map {
                RemoteAction(
                    it.icon ?: Icon.createWithResource(activity, R.mipmap.ic_launcher_foreground),
                    it.title.orEmpty(),
